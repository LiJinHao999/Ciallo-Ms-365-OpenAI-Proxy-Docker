...
_ADMIN_I18N_JS = """const i18n={
  zh:{
    ...
    title_accounts:'账户池',btn_add_account:'添加账户',btn_oauth_login:'微软登录',
    ...
    accounts_hint:'每个账户拥有独立的 M365 Token 与 Chromium 刷新配置。推荐用「微软登录」走 PKCE 拿 RT；Cookie/CDP 仍可用于媒体增强。',
    oauth_form_hint:'点击开始后浏览器打开微软登录。若跳到 wrongplace，复制仍带 code= 的完整地址粘贴提交。可选绑定当前选中账户，否则新建账户。',
    oauth_start_btn:'打开微软登录',oauth_submit_btn:'提交回调 URL',oauth_callback_ph:'粘贴 nativeclient?code=...&state=... 完整 URL',
    oauth_starting:'打开中...',oauth_submitting:'提交中...',oauth_ok:'登录成功',oauth_failed:'登录失败',
    ...
    valid_short:'有效',invalid_short:'无效',cookie_valid_short:'有效',cookie_invalid_short:'无效',cookie_optional_short:'可选',cookie_optional_na:'可选·未注入',cookie_updated_label:'刷新',cookie_expires_label:'过期',media_image:'图片',media_attach:'附件',refresh_auto:'自动(CDP)',refresh_auto_rt:'自动(RT)',refresh_manual:'手动',refresh_unavailable:'不可用',login_mode_none:'未登录',login_mode_oauth:'微软登录(OAuth)',login_mode_rt:'RT 自动续期',login_mode_cookie:'Cookie 会话',login_mode_token:'仅 Token',col_login_mode:'登录方式',col_rt:'RT',rt_ready_short:'已就绪',rt_missing_short:'缺失',no_accounts:'暂无账户',no_keys:'暂无 Key',unbound:'未绑定',acct_token_only:'Token',
  ...
  en:{
    ...
    title_accounts:'Account Pool',btn_add_account:'Add account',btn_oauth_login:'Microsoft Login',
    ...
    accounts_hint:'Each account owns an isolated M365 token and Chromium refresh profile. Prefer Microsoft Login (PKCE) for RT; cookies/CDP remain useful for media extras.',
    oauth_form_hint:'Click start to open Microsoft sign-in. If the page jumps to wrongplace, paste the earlier full URL that still has code=. Optionally binds the selected account; otherwise creates a new one.',
    oauth_start_btn:'Open Microsoft Login',oauth_submit_btn:'Submit callback URL',oauth_callback_ph:'Paste full nativeclient?code=...&state=... URL',
    oauth_starting:'Opening...',oauth_submitting:'Submitting...',oauth_ok:'Logged in',oauth_failed:'Login failed',
    ...
    btn_refresh:'Sync',btn_token_refresh:'Sync',btn_cookie_refresh:'Sync',btn_remove_token:'Clear',btn_rebind:'Bind',btn_delete:'Del',btn_copy:'Copy',btn_enable:'On',btn_disable:'Off',btn_push_token:'Set',
    ...
    valid_short:'OK',invalid_short:'Bad',cookie_valid_short:'OK',cookie_invalid_short:'Bad',cookie_optional_short:'Optional',cookie_optional_na:'Optional · none',cookie_updated_label:'Upd',cookie_expires_label:'Exp',media_image:'Image',media_attach:'File',refresh_auto:'Auto (CDP)',refresh_auto_rt:'Auto (RT)',refresh_manual:'Manual',refresh_unavailable:'Unavailable',login_mode_none:'Not signed in',login_mode_oauth:'Microsoft OAuth',login_mode_rt:'RT auto-refresh',login_mode_cookie:'Cookie session',login_mode_token:'Token only',col_login_mode:'Login',col_rt:'RT',rt_ready_short:'Ready',rt_missing_short:'Missing',no_accounts:'No accounts yet',no_keys:'No keys yet',unbound:'Unbound',acct_token_only:'Token',
