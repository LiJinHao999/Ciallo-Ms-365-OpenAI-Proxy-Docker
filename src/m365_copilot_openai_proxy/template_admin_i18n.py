...
_ADMIN_I18N_JS = """const i18n={
  zh:{
    ...
    btn_clear_image_quota:'解除触顶',img_clear_ok:'已解除',img_clear_fail:'失败',img_no_accounts:'暂无账户',
  ...
  en:{
    ...
    btn_clear_image_quota:'Clear block',img_clear_ok:'Cleared',img_clear_fail:'Failed',img_no_accounts:'No accounts',
