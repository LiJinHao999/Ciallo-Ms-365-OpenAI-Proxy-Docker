...
_USER_I18N_JS = """const i18n={
  zh:{
    ...
    oauth_title:'微软登录（推荐）',oauth_hint:'点击后在浏览器登录微软账号。若页面跳到 wrongplace，请复制仍带 code= 的完整地址并粘贴到下方。',oauth_start_btn:'微软登录',oauth_submit_btn:'提交回调 URL',oauth_starting:'打开登录页...',oauth_submitting:'提交中...',oauth_ok:'登录成功',oauth_failed:'登录失败',oauth_ph:'粘贴 https://login.microsoftonline.com/common/oauth2/nativeclient?code=...&state=...',
  ...
  en:{
    ...
    oauth_title:'Microsoft login (recommended)',oauth_hint:'Click to open Microsoft sign-in. If the page jumps to wrongplace, copy the earlier full URL that still contains code= and paste it below.',oauth_start_btn:'Microsoft Login',oauth_submit_btn:'Submit callback URL',oauth_starting:'Opening...',oauth_submitting:'Submitting...',oauth_ok:'Logged in',oauth_failed:'Login failed',oauth_ph:'Paste https://login.microsoftonline.com/common/oauth2/nativeclient?code=...&state=...',
    mode_profile_title:'Defaults',user_tone_hint:'After saving, this only affects the current user and will no longer follow the global template.',call_params_title:'Call params',manual_update_title:'Manual update',status_panel_title:'Status',status_account:'Account',status_login:'Login',status_refresh:'Refresh',status_valid:'Valid',status_expire:'Expires',status_remaining:'left',status_yes:'Yes',status_no:'No',status_unknown:'Unknown',account_none:'None',account_none_token:'None (Token)',
